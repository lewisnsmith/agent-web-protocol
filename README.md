...
1. **The Human Web Plane:** The visual, UI-rich internet designed for people. This remains unchanged.
2. **The Agent Execution Plane:** A parallel, machine-native layer optimized for structured, verifiable, and secure agent-to-agent interactions.
...
📖 **Dive Deeper:** For the complete architectural breakdown, protocol primitives, and implementation strategy, read the full [AEXP Proposal Document](./AEXP_Proposal.md).
